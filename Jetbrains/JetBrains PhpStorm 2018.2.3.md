# JetBrains PhpStorm 2018.2.3 Windows/Linux/macOS #  
...
https://download.jetbrains.com/webide/PhpStorm-2018.2.3.exe

macOS

https://download.jetbrains.com/webide/PhpStorm-2018.2.3.dmg

Linux

https://download.jetbrains.com/webide/PhpStorm-2018.2.3.tar.gz
...
JetBrains PhpStorm 2018.2.1+激活破解除去黄色警告框

https://www.imsxm.com/2018/07/idea-2018-1-5-crack-patcher.html

最近更新了JetBrains PhpStorm 2018.2.1+之后，使用之前的授权服务器(http://idea.imsxm.com)会提示Outdated License Server Detected，大意就是下个版本的IDEA会更换授权服务器的算法，之前破解的算法会失效。
...
打开JetBrains PhpStorm 2018.2.1+,依次点击help-Register… 弹出对话框

点击左下角的Remove License即可去除激活信息，然后点击exit退出PhpStorm
...
用补丁代替JetBrains PhpStorm 2018.2.1+的验证

1.打开JetBrains PhpStorm 2018.2.1+的JVM配置文件，一般会在C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin下的phpstorm64.exe.vmoptions和phpstorm.exe.vmoptions文件,如果找不到可以在JetBrains PhpStorm 2018.2.1+中点击”Configure” -> “Edit Custom VM Options …”自动打开

2.在该文件最后添加一句:-javaagent:{JetbrainsCrack-3.1-release-enc.jar补丁的路径} 

C:\Program Files\JetBrains\PhpStorm 2018.2.3

C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin

/Applications/PhpStorm.app/Contents

/Applications/PhpStorm.app/Contents/bin

例如:

【Windows】
C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin\phpstorm64.exe.vmoptions和C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin\phpstorm.exe.vmoptions分别添加：
-javaagent:C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin\JetbrainsCrack-3.1-release-enc.jar

【macOS】
/Applications/PhpStorm.app/Contents/bin/phpstorm.vmoptions添加
-javaagent:/Applications/PhpStorm.app/Contents/bin/JetbrainsCrack-3.1-release-enc.jar

直接编辑修改权限不足的可以复制粘贴到桌面修改完毕再复制粘贴替换原文件即可

3.重启JetBrains PhpStorm 2018.2.1+
...
https://downloadly.ir/software/programming/jetbrains-phpstorm-2/

http://dl.downloadly.ir/Files/Software2/JetBrains_PhpStorm_2018.2.3_Windows_Downloadly.ir.rar

http://dl.downloadly.ir/Files/Software2/JetBrains_PhpStorm_2018.2.3_macOS_Downloadly.ir.rar

http://dl.downloadly.ir/Files/Software2/JetBrains_PhpStorm_2018.2.3_Linux_Downloadly.ir.rar

http://dl.downloadly.ir/Files/Software2/Jetbrains_2018.2_All_IDE_Crack_Rover_v3.10_Build_2018-08-12_Downloadly.ir.rar

JetBrains PhpStorm 2018.2.3

https://www.0daydown.com/08/862061.html

Download rapidgator
https://rg.to/file/16908108a893a804dce1947783410762/JetBrains.PhpStorm.2018.2.3.rar.html

Download nitroflare
http://nitroflare.com/view/753F2062201095D/JetBrains.PhpStorm.2018.2.3.rar

Download 城通网盘
https://u7940988.ctfile.com/fs/7940988-306053224

Download 百度云
链接: https://pan.baidu.com/s/1T_iLX-k0pCC5_nDFec2mVw 密码: u5v9
...
for example: -javaagent:C:\Program Files\JetBrains\PhpStorm 2018.2.3\bin\JetbrainsCrack-3.1-release-enc.jar
